...
int main()
{
    ...
    int inmt_g_opt[] = {1, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1, 1}; // Optimal choices of parameter inmt_g in the second test round, for m=1000 and n=100.
    int inmt_d_opt[] = {1, 1, 0, 0, 0, 1, 1, 0, 1, 0, 1, 1}; // Optimal choices of parameter inmt_d in the second test round, for m=1000 and n=100.
